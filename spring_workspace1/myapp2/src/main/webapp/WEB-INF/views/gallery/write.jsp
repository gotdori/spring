...
$(()=>{
	$("#btnSave").click(()=>{
		//파일을 전송 할때는 FormData 객체를 만들어서 보내야한다.
		//자바스크립트로 파일 전송 할 때 FormData 개체를 만든다.
		//$("#myform")[0]
		//document.myform;
		let frmData = new FormData($("#myform")[0]);
		console.log(frmData);
		
// 		//image1의 내용 가져와서 type체크하기
		...
		$.ajax({
			...
			enct ype:"multipart/form-data", //fileupload시 꼭 필요
			timeout:600000, 	//전송시간 제한
			dataType:"json",	//데이터 수신시 json으로 받기
			type:"POST"			//fileupload시 꼭 필요, 전송방식 POST
		})
		.done((res)=>{
			console.log(res);
		})
